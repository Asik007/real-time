...
view.show()
view.setWindowTitle('Pressure monitoring')
...
# Title at top
text = """
Modified code to monitor pressure over time
(Orginially developed at the Universidad Distrital FJC.)
"""
...
def update():
    try:
        ...
        # free_fall.update(value_chain[0])
